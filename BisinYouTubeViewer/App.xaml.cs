...
using BisinIPT101Solution.BisinDomain.Queries;
using BisinIPT101Solution.BisinFramework;
using BisinIPT101Solution.BisinFramework.Commands;
using BisinIPT101Solution.BisinFramework.Queries;
using BisinIPT101Solution.BisinYouTubeViewer.Stores;
using BisinIPT101Solution.BisinYouTubeViewer.ViewModels;
using BisinIPT101Solution.BisinYouTubeViewer.HostBuilders;
using Microsoft.EntityFrameworkCore;

namespace BisinIPT101Solution.BisinYouTubeViewer
{
    /// <summary>
